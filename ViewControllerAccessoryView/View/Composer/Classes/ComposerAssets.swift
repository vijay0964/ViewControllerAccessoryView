...
public struct ComposerAssets {
    ...
    public static let chatAnimationSelectedImage = imageNamed("chatAnimationSelected")
    public static let chatAnimationUnSelectedImage = imageNamed("chatAnimationUnselected")
