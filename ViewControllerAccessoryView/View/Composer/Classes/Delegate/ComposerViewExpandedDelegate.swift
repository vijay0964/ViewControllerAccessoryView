...
public protocol ComposerViewExpandedDelegate: ComposerViewDelegate,
    ...
    func composerView(_ composerView: ComposerView, didPressChatAnimationButton button: UIButton)
    func removeAccessoryViewSubviews()
    func composerViewDidRequestMicrophoneAlert()
}
...
public extension ComposerViewExpandedDelegate {
    ...
    func composerView(_ composerView: ComposerView, willConfigureButton button: ComposerButton) {
        func isEmpty() -> Bool {
            return composerView.textView.text.isEmpty ||
            composerView.textView.text.trimmingCharacters(in: CharacterSet.whitespacesAndNewlines).isEmpty
        }
    ...
    func composerView(_ composerView: ComposerView, didPressRecordAudioButton button: UIButton) {
        ...
        case .denied:
            composerViewDidRequestMicrophoneAlert()
        case .undetermined:
