...
public class ComposerView: UIView, ComposerLocalizable {
    ...
    public let leftButton = tap(ComposerButton()) {
        $0.translatesAutoresizingMaskIntoConstraints = false
        $0.setImage(ComposerAssets.addButtonImage, for: .normal)
    ...
    public let rightButton = tap(ComposerButton()) {
        $0.translatesAutoresizingMaskIntoConstraints = false
        $0.setImage(ComposerAssets.sendButtonImage, for: .normal)
...
extension ComposerView: ComposerTextViewDelegate {
...
extension ComposerView: UITextViewDelegate {
    public func textViewShouldBeginEditing(_ textView: UITextView) -> Bool {
        currentDelegate.composerViewBeginEditing(self)
        return true
    }
